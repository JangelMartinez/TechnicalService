...
const ModalDelCompany = ({btnv, HandleClick}) => {
			...
			<Modal isOpen={btnv} size="lg" centered="true">
				...
				<ModalBody>
							<div className="row mt-4">
								<p>¿Desea eliminar la empresa <span className="fw-bold">{btnv.data.name}</span> permanentemente?</p>
...
export default ModalDelCompany;